...
describe('PlanqFiFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as PlanqFiFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('PlanqFiPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('PlanqFiPool')
