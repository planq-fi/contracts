...
import '../../../../../contracts/PlanqFiFactory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the planqFi factory will do when you create the pool
...
contract SetupPlanqFi {
    PlanqFiPool public pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    PlanqFiFactory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new PlanqFiFactory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = PlanqFiPool(factory.createPool(address(token0), address(token1), _fee));
        pool.initialize(_startPrice);
    }
}

contract PlanqFiMinter {
    PlanqFiPool pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    function setPool(PlanqFiPool _pool) public {
        pool = _pool;
    }
